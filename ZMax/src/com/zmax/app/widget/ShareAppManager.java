...
public final class ShareAppManager {
    ...
    private String LogTag = ShareAppManager.class.getCanonicalName();
    private final String[] packageNameList =
            {"com.android.mms", "com.alibaba.android.babylon", "com.tencent.mm", "com.tencent.mobileqq",
                    "com.sina.weibo"};
    ...
    public static final List<Map<String, String>> sharePackageList = new ArrayList<Map<String, String>>() {{
        ...
        add(new HashMap<String, String>() {{
            ...
            put("launcher", "com.tencent.mobileqq.activity.JumpActivity");
        ...
        add(new HashMap<String, String>() {{
            ...
            put("launcher", "com.alibaba.android.babylon.biz.im.activity.RecentIMListActivity");
        ...
        add(new HashMap<String, String>() {{
            put("name", "来往-动态");
            put("package", "com.alibaba.android.babylon");
            put("launcher", "com.alibaba.android.babylon.biz.home.activity.WriteFeedActivity");
            put("icon", "logo_laiwang.png");
        }});
...
//       Log.d(LogTag, Arrays.toString(packageNameList));
     ...
     * @param packageName
     */
    private boolean checkPackage(Context context, String packageName) {
     ...
     * @return
     */
    private boolean isInstalledMarket(Context context, Intent intent) {
        List<ResolveInfo> marketApps =
     ...
     * 分享对应的app.并设置对应的属性,
     */
    public void shareTo(Context context, String packageName, String launcherClassName, String content) {

        if (checkPackage(context, packageName)) {
            Intent share = new Intent(Intent.ACTION_SEND);
            share.setPackage(packageName);
            share.setClassName(packageName, launcherClassName);
            Log.d(LogTag, String.format("shareTo launcher > %s", launcherClassName));
            //默认是文字形式分享
            ...
            if (packageName.equalsIgnoreCase("com.sina.weibo") ||
                    packageName.equalsIgnoreCase("com.alibaba.android.babylon") ||
            ...
            gotoMarket.setData(Uri.parse(String.format("market://search?q=pname:%s", packageName)));

            if (isInstalledMarket(context, gotoMarket)) {
                context.startActivity(gotoMarket);
            } else {
                context.startActivity(new Intent(Intent.ACTION_VIEW)
                        .setData(Uri.parse(String.format("http://market.android.com/search?q=pname:%s", packageName))));
            }
