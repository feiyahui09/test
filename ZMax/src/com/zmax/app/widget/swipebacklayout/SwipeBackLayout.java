package com.zmax.app.widget.swipebacklayout;
...
public class SwipeBackLayout extends FrameLayout {
	...
	private class ViewDragCallback extends ViewDragHelper.Callback {
		...
		public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
			...
			if (mListeners != null && !mListeners.isEmpty() && mDragHelper.getViewDragState() == STATE_DRAGGING
		...
		public void onViewReleased(View releasedChild, float xvel, float yvel) {
			...
			if ((mTrackingEdge & EDGE_LEFT) != 0) {
				...
				left = xvel < 0 || xvel == 0 && mScrollPercent > mScrollThreshold ? -(childWidth + mShadowLeft.getIntrinsicWidth() + OVERSCROLL_DISTANCE)
						: 0;
			}
			else if ((mTrackingEdge & EDGE_BOTTOM) != 0) {
