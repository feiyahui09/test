...
public class CounterPullDoorView extends RelativeLayout {
	...
	public CounterPullDoorView(Context context) {
		super(context);
		mContext = context;
		setupView();
	}
	
	public CounterPullDoorView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setupView();
	}
	...
	private void setupView() {
		...
		// mImgView.setBackgroundColor(R.color.green);; // 默认背景
		addView(mImgView);
	}
	...
	public void computeScroll() {
		...
		if (mScroller.computeScrollOffset()) {
			...
			Log.i("scroller", "getCurrX()= " + mScroller.getCurrX() + "     getCurrY()=" + mScroller.getCurrY() + "  getFinalY() =  "
					+ mScroller.getFinalY());
			// 不要忘记更新界面
			postInvalidate();
		}
	...
	public interface CounterPullCallBack {
		
		public void onCounterClosed();
	}
}
