...
import com.zmax.app.ui.fragment.*;
 ...
 * @author jeremyssss
 */
public class BaseSlidingFragmentActivity extends SlidingFragmentActivity implements MoreMenuFragment
		.TabSelectedListener {
	...
	TabListener<ActListFragment> actTabListener = new TabListener<ActListFragment>(this, "ActListFragment",
			ActListFragment.class);
	...
	TabListener<SettingFragment> settingTabListener = new TabListener<SettingFragment>(this, "SettingFragment",
			SettingFragment.class);
	TabListener<AccountFragment> accountTabListener = new TabListener<AccountFragment>(this, "AccountFragment",
			AccountFragment.class);
	TabListener<PlayInZmaxFragment> playInZmaxTabListener = new TabListener<PlayInZmaxFragment>(this,
			"PlayInZmaxFragment",
	...
	public void showLogoutView() {
		...
		btn_share.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				progressDialog = ProgressDialogFragment.createBuilder(BaseSlidingFragmentActivity.this,
						getSupportFragmentManager()).setMessage("正在注销中...").setTitle("提示")
