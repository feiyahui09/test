...
public class RoomControlWakeUpFragment extends Fragment {
	...
	public RoomControlWakeUpFragment(VerticalChangedCallback callback) {
		this.callback = callback;
		setRetainInstance(true);
	}
	
	public RoomControlWakeUpFragment(VerticalChangedCallback callback, PageChangedCallback pageChangedCallback) {
		this.callback = callback;
	...
	private static View getAbove(LayoutInflater inflater) {
		...
		big_icon.setImageResource(R.drawable.room_control_above_wakeup);
		TextView tv_mode = (TextView) view.findViewById(R.id.tv_mode_tile);
		tv_mode.setText("叫醒服务");
