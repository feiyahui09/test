...
public class ActDetailThirdFragment extends Fragment implements RefreshDataCallBack {
	...
	private void initView(ActDetailContent detailContent) {
		tv_begin_time.setText(detailContent.event_begin);
		// ImageLoader.getInstance().displayImage("http://www.120ask
		// .com/static/upload/clinic/index/big/201212/big_201212241738148789.jpg",
		// iv_img);
		// 活动酒店列表显示
	...
	private void initHotels(List<ActDetailHotel> detailHotels) {
		...
		adapter.clear();
		int value = PhoneUtil.isLowDensity(getActivity()) ? 1 : 2;
