...
public class RoomControlCurtainFragment extends Fragment {
	...
	public RoomControlCurtainFragment(VerticalChangedCallback callback) {
		this.callback = callback;
		setRetainInstance(true);
	}
	
	public RoomControlCurtainFragment(VerticalChangedCallback callback, PageChangedCallback pageChangedCallback) {
		this.callback = callback;
	...
	private static View getAbove(LayoutInflater inflater) {
		...
		big_icon.setImageResource(R.drawable.room_control_above_curtain);
		TextView tv_mode = (TextView) view.findViewById(R.id.tv_mode_tile);
		tv_mode.setText("窗帘控制");
